...
export async function upsertJob(input: JobUpsertInput) {
  ...
  return prisma.job.upsert({
    ...
    create: {
      ...
      applicationSummary: input.applicationGuidance.summary || null,
      essentialRequirements: input.applicationGuidance.essentialRequirements,
      preferredRequirements: input.applicationGuidance.preferredRequirements,
      requiredQualifications: input.applicationGuidance.qualifications,
      requiredExperience: input.applicationGuidance.experience,
      documentsToPrepare: input.applicationGuidance.documents,
      licenceRequirements: input.applicationGuidance.licences,
      applicationMethod: input.applicationGuidance.applicationMethod || null,
      referenceNumber: input.applicationGuidance.referenceNumber || null,
      estimatedApplicationMinutes: input.applicationGuidance.estimatedApplicationMinutes || null,
      applicationGuidanceGeneratedAt: input.applicationGuidanceGeneratedAt ? new Date(input.applicationGuidanceGeneratedAt) : null,
    ...
    update: {
      ...
      referenceNumber: input.applicationGuidance.referenceNumber || null,
      estimatedApplicationMinutes: input.applicationGuidance.estimatedApplicationMinutes || null,
      applicationGuidanceGeneratedAt: input.applicationGuidanceGeneratedAt ? new Date(input.applicationGuidanceGeneratedAt) : undefined,
      highlights: input.highlights,
      applyUrl: input.applyUrl ?? null,
      rewritePrompt: input.rewritePrompt ?? null,
      isNative: input.isNative,
