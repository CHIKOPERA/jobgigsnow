...
export const careerSources: CreateSourceInput[] = [
  ...
  {
    name: "Graduates24 Graduate Programmes",
    baseUrl: "https://www.graduates24.com/graduate_programmes",
    cadenceMinutes: 360,
    enabled: true,
    crawlConfig: {
      provider: "html",
      categoryHint: "GRADUATE_PROGRAMME",
      listingUrls: ["https://www.graduates24.com/graduate_programmes"],
  ...
  {
    name: "Graduates24 Bursaries",
    baseUrl: "https://www.graduates24.com/bursaries",
    cadenceMinutes: 360,
    enabled: true,
    crawlConfig: {
      provider: "html",
      categoryHint: "FUNDING",
      listingUrls: ["https://www.graduates24.com/bursaries"],
      linkSelector: ".g24-job-card > a.g24-card-link",
      linkAttr: "href",
      pagination: successFactorsPagination,
    },
  ...
  {
    name: "Graduates24 Learnerships and Apprenticeships",
    baseUrl: "https://www.graduates24.com/learnerships",
    cadenceMinutes: 360,
    enabled: true,
    crawlConfig: {
      provider: "html",
  ...
  },
  {
    ...
    baseUrl: "https://internationalscholarships.dhet.gov.za/index.php/scholarships",
    cadenceMinutes: 720,
    enabled: true,
    crawlConfig: {
      provider: "html",
      categoryHint: "FUNDING",
      listingUrls: ["https://internationalscholarships.dhet.gov.za/index.php/scholarships"],
      linkSelector: 'a.uk-flex-1.uk-inline-clip.uk-link-toggle[href*="/scholarships/"]',
      linkAttr: "href",
    },
  },
  {
    name: "StudyTrust Bursaries",
    baseUrl: "https://studytrust.org.za/bursaries/",
    cadenceMinutes: 720,
    enabled: true,
    crawlConfig: {
      provider: "html",
      categoryHint: "FUNDING",
      listingUrls: ["https://studytrust.org.za/bursaries/"],
      linkSelector: ".et_pb_section_1 .et_pb_text_inner a[href]",
      linkAttr: "href",
    },
  },
  {
    name: "ESASTAP Open Calls",
    baseUrl: "https://www.esastap.org.za/open-calls/",
    cadenceMinutes: 720,
    enabled: true,
    crawlConfig: {
      provider: "html",
      categoryHint: "CALL_FOR_APPLICATIONS",
      listingUrls: ["https://www.esastap.org.za/open-calls/"],
      linkSelector: ".post-content.fit-text-main > a[href]",
      linkAttr: "href",
    },
  },
  {
    name: "National Arts Council Funding Calls",
    baseUrl: "https://www.nac.org.za/category/funding-news/",
    cadenceMinutes: 720,
    enabled: true,
    crawlConfig: {
      provider: "html",
      categoryHint: "CALL_FOR_APPLICATIONS",
      listingUrls: ["https://www.nac.org.za/category/funding-news/"],
      linkSelector: 'h2.entry-title a.plain[href*="/call"]',
      linkAttr: "href",
    },
  },
  {
    name: "South African Reserve Bank Careers",
    baseUrl: "https://fa-evra-saasfaprod1.fa.ocs.oraclecloud.com/hcmUI/CandidateExperience/en/sites/SARB",
    cadenceMinutes: 360,
    enabled: true,
    crawlConfig: {
      provider: "oracle",
      ...
      siteNumber: "SARB",
      companyName: "South African Reserve Bank",
      language: "en",
      pageSize: 100,
      maxPages: 10,
    },
  ...
  {
    name: "Nedbank Graduate Careers",
    baseUrl: "https://jobs.nedbank.co.za/content/Graduates/?locale=en_GB",
    cadenceMinutes: 360,
    enabled: true,
    crawlConfig: {
      provider: "html",
  ...
  {
    name: "NPC Careers and Development Programmes",
    baseUrl: "https://npc.co.za/careers-internships-learnerships-bursaries/",
    cadenceMinutes: 360,
    enabled: true,
    crawlConfig: {
      provider: "html",
  ...
  {
    name: "Standard Bank Graduate Opportunities",
    baseUrl: "https://careers.standardbank.com/sbg/standard-bank-group/careers/early-careers/graduate-programmes/opportunities",
    cadenceMinutes: 360,
    enabled: true,
    crawlConfig: {
      provider: "smartrecruiters",
      categoryHint: "GRADUATE_PROGRAMME",
      companyIdentifier: "StandardBankGroup",
      query: "graduate",
      country: "za",
      pageSize: 100,
      maxPages: 10,
